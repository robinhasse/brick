...
p_specCostOpe(cost,bs,hs,vin,region,loc,typ,ttot)             "floor-space specific operation cost [USD/m2/yr]"
p_specCostDem                                                 "floor-space specific demolition cost [USD/m2]"

p_maintenanceCost(bs,hs,region,loc,typ) "floor-space specific operation and maintenance cost (excl. energy carrier and carbon price) [USD/m2/yr]"
