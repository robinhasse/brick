...
v_EntropyRenBS(bs,hs,vin,region,loc,typ,inc,ttot) "diversity in building shell retrofit"
v_EntropyRenHS(bs,hs,vin,region,loc,typ,inc,ttot) "diversity in heating system replacement"
...
q_EntropyRenBS(bs,hs,vin,region,loc,typ,inc,ttot) "diversity in building shell retrofit"
q_EntropyRenHS(bs,hs,vin,region,loc,typ,inc,ttot) "diversity in heating system replacement"
