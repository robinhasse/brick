...
R package **brick**, version **0.5.10.9991**
...
Hasse R, Rosemann R (2024). _brick: Building sector model with heterogeneous renovation and construction of the stock_. R package version 0.5.10.9991, <https://github.com/pik-piam/brick>.
...
@Manual{,
  ...
  year = {2024},
  note = {R package version 0.5.10.9991},
