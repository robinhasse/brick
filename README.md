...
R package **brick**, version **0.1.3.9001**
...
Hasse R (2024). _brick: Building sector model with heterogeuous renovation and construction of the stock_. R package version 0.1.3.9001, <URL: https://github.com/pik-piam/brick>.
